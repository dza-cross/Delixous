...
class EcopointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ecopoint" do
    assert_difference('Ecopoint.count') do
      post ecopoints_url, params: { ecopoint: { address_id: @ecopoint.address_id, category_id: @ecopoint.category_id, name: @ecopoint.name } }
    end
  ...
  test "should update ecopoint" do
    patch ecopoint_url(@ecopoint), params: { ecopoint: { address_id: @ecopoint.address_id, category_id: @ecopoint.category_id, name: @ecopoint.name } }
